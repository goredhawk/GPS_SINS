%  stm32=textread('C:\Users\heshufan\Desktop\6.20大学城数据采集\pureGPS\pureGPS.txt','%s')';
% stm32=textread('C:\Users\heshufan\Desktop\6.20大学城数据采集\第一次采集\第一次跑车静止采集GPS.txt','%s')';
% stm32=textread('C:\Users\heshufan\Desktop\6.20大学城数据采集\第一次采集\第一次跑车采集GPS.txt','%s')';
% stm32=textread('F:\定位\严恭敏\psins160731_原始_实际数据\6.21华工第二次数据采集\GPS_sport2.txt','%s')';
n=size(stm32,2);%列数
h=n/27;
Re=6378137;
