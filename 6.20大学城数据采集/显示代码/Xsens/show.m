...
DATA=importdata('F:\定位\严恭敏\psins160731_原始_实际数据\6.21华工第二次数据采集\INS_Sport2-000.txt');
% DATA=importdata('C:\Users\heshufan\Desktop\6.20大学城数据采集\第一次采集\INS_sport1-000.txt');
