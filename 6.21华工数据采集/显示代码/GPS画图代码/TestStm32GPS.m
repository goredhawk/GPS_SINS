 stm32=textread('C:\Users\Administrator\Desktop\6.20大学城数据采集\第一次采集\第一次跑车采集GPS.txt','%s')';
% stm32=textread('C:\Users\Administrator\Desktop\6.20大学城数据采集\第一次采集\第一次跑车静止采集GPS.txt','%s')';
n=size(stm32,2);%列数
h=n/27;
Re=6378137;
